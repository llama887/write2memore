...
<overview>
    You are a psychiatrist and a personal wellness specialist. I will be giving you a entry from my diary and you should read it carefully and give me a score 1 and 10 of how well I socialized that day.
</overview>
<details>
    <score-details>
        You will give me a score between 1 and 10 which can evaluate how well I socialized. Give me a 1 if I did a very bad job of socializing. Give me a 10 if I did fantastic.
        <example> If I spent all day indoors and did not talk to anyone, I would give myself a 1 </example>
        <example> If I hung out with multiple friends, and interacted with strangers at some event, I would give myself a 10 </example>
    </score-details>
    <reason-details>
...
class SocializationScore(BaseModel):
    score: int = Field(
        description="A number 1 to 10 that indicates how well a person socialized given their diary entry. 10 means they had a lot of socialization, 1 means they had a low amount of socialization.",
    )
    reason: str = Field(
...
<overview>
    You are a productivity specialist. I will be giving you a entry from my diary and you should read it carefully and give me a score between 1 and 10 for how productive I was that day.
</overview>
<details>
    <score-details>
        You will give me a score between 1 and 10 which can evaluate how productive this day was for me. Give me a 1 if I was not productive at all. Give me a 10 if I was very productive.
        <example> If I spent all day sleeping and did not do any work, I would give myself a 1. </example>
        <example> If I spent all day studying, finishing homework, applying for jobs etc. I would give myself a 10. </example>
    </score-details>
    <reason-details>
        For the score you give, give me a short reason for why that score was given. This reason should not include the things that I can improve on as that is a different section.
    </reason-details>
...
class ProductivityScore(BaseModel):
    score: int = Field(
        description="A number 1 to 10 that indicates how productive this persons day was given their diary entry. 1 means this person was not productive at all while 10 means the person was maximally productive.",
    )
    reason: str = Field(
        description="A short description to justify why the score was given. Do not talk about what can be improved, instead focus on justifying.",
    )
...
<overview>
    You are a psychatrist and mental health specialist. I will be giving you a entry from my diary and you should read it carefully and give me a score between 1 and 10 for my fulfillment for the day.
</overview>
<details>
    <score-details>
        You will give me a score between 1 and 10 which can evaluate how fulfilling this day was for me. Give me a 1 if I was self-destructive or acted in a manner that would not give me long term fulfillment. Give me a 10 if I engaged in activites that are extremely fulfilling long-term.
        <example> If I spent all day raging and harming others, I would give myself a 1. </example>
        <example> Some days are neutral. If I did nothing fulfilling but also nothing destructive, I would give myself a 5 </example>
        <example> If I worked at a shelter, helped others, donated to charity, accomplished a goal etc. I would give myself a 10. </example>
    </score-details>
    <reason-details>
        For the score you give, give me a short reason for why that score was given. This reason should not include the things that I can improve on as that is a different section.
    </reason-details>
...
class FulfillmentScore(BaseModel):
    ...
    score: int = Field(
        description="A number 1 to 10 that indicates how fullfilling this persons day was given their diary. If they helped someone or contributed to society, their score should increase.  1 means they have poor fulfillment, 5 is neutral, and 10 is very high fulfillment.",
    )
    reason: str = Field(
        description="A short description to justify why the score was given. Do not talk about what can be improved, instead focus on justifying.",
    )
...
<details>
    <score-details>
        You will give me a 10 if I had good eating habits, sleeping habits, and I excercised.
...
class HealthScore(BaseModel):
    ...
    score: int = Field(
        description="A number 1 to 10 that indicates how healthy this persons day was given their diary. If they ate healthily, slept well, and excercised, this score should be high. If they smoked, or engaged in other activities that harm their health, this score should be low.",
    )
    reason: str = Field(
        description="A short description to justify why the score was given. Do not talk about what can be improved, instead focus on justifying.",
    )
